...
function solve_prob(parameters, numg0, seed = nothing)
...
y = sol
solve_prob(parameters, numg0, 123)
...
solve_prob(parameters, numg0)[16]  # p is the 16th variable in the solution
final_p_values = Float64[]
for numg0_val in numg0_values
    final_p = solve_prob(parameters, numg0_val)
